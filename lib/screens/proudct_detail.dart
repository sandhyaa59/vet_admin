    ...
    return flag
        ? Row(
            ...
            children: [
              ...
              child:
              showTitleContent("Product Name : ",
                  controller.selectedOrder.value.employeeName ?? "")),
                SizedBox(width: Get.size.width*0.3,
                 child:showTitleContent("Category : ",
  ...
  Widget customerOrderDetails(BoxConstraints constraints, bool flag) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 10.0),
        showTitleContent("Tax : ",
            controller.selectedOrder.value.customerAddress ?? ""),
            const SizedBox(height: 10.0),
        showTitleContent("Price : ", controller.selectedOrder.value.shopName ??""),
        const SizedBox(height: 10.0),
        showTitleContent(" ", controller.selectedOrder.value.customerPan ??"")
  ...
  Widget orderStatus(bool flag) {
    return flag
        ? Row(
            ...
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
                showTitleContent("Stock : ",
                  controller.selectedOrder.value.addedDateTime ?? ""),
                    showTitleContent("Unit : ",
                  controller.selectedOrder.value.addedDateTime ?? ""),
              showTitleContent("Product Description ",
        ...
        : Column(
            ...
            children: [
             showTitleContent("Stock : ",
                  controller.selectedOrder.value.addedDateTime ?? ""),  const SizedBox(height: 10.0),
                    showTitleContent("Unit : ",
                  controller.selectedOrder.value.addedDateTime ?? ""),  const SizedBox(height: 10.0),
              showTitleContent("Product Description ",
                  controller.selectedOrder.value.status ?? ""),
