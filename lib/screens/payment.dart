    ...
    return SingleChildScrollView(
        ...
        child: SizedBox(
          ...
          child: PaginatedDataTable(
            header: const Text("Payment", style:
  ...
  DataRow? getRow(int index) {
    ...
    return DataRow(
        cells: <DataCell>[
          ...
          DataCell(Text(payment[index].paymentNumber ?? "",)),
          DataCell(Text(payment[index].amount.toString(),)),
                    DataCell(Text(payment[index].addedAt ?? "",
          )),
           DataCell(IconButton(onPressed: (){
            controller.selectedPayment.value=payment[index];
