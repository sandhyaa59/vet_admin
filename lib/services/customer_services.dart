...
class CustomerService{
  static Future<dynamic> customerList()async{

try {
  var token=await StorageUtil.getValue("token");
  Uri uri=Uri.parse(EndPoints.CUSTOMER_LIST);
   var headers = {
      ...
      var response = await http.get(uri,
          headers: headers);
           ...
           CustomerListResponse customerListResponse=customerListResponseFromJson(res);
...
static Future<dynamic> addCustomer(CustomerAddRequest addRequest)async{
 ...
 var token=await StorageUtil.getValue("token");
      ...
      body: customerAddRequestToJson(addRequest));
    var res=handleResponse(response);
    return res;
...
static Future<dynamic> updateCustomer(CustomerUpdateRequest updateRequest)async{
  try {
 ...
 var token=await StorageUtil.getValue("token");
      ...
      var response=await http.post(uri,headers: headers,
      body: customerUpdateRequestToJson(updateRequest));
    var res=handleResponse(response);
    return res;
